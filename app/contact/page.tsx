...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Green Valley Food Co-op. We\'d love to hear from you about membership, products, or community programs.',
  keywords: ['Contact Green Valley Food Co-op', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about membership, products, or community programs? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@greenvalleycoop.com</p>
                    <p className="text-gray-600">support@greenvalleycoop.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 678-9002</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      425 Harvest Street<br />
                      Farmers Market District<br />
                      Burlington, VT 05401
                    </p>
                  </div>
                </div>
